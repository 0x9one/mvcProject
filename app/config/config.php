...
define('assetsC',  '/assets/css/');
define('assetsJ',  '/assets/js/');

define('errorC',  '/errors/css/');

define('ASSETS_PATH', APP_PATH  . DS . 'template' . DS . 'assets' . DS);
define('ERRORS_PATH', APP_PATH  . DS . 'template' . DS . 'error' . DS);


// Database Credentials
defined('DATABASE_HOST_NAME')       ? null : define ('DATABASE_HOST_NAME', 'localhost');
defined('DATABASE_USER_NAME')       ? null : define ('DATABASE_USER_NAME', 'swapcode');
defined('DATABASE_PASSWORD')        ? null : define ('DATABASE_PASSWORD', 'swap');
