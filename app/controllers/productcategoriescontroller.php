...
use PHPMVC\Models\ProductsCategorysModel;
...
class ProductCategoriesController extends AbstractController
{
    ...
    public function defaultAction()
    {
        ...
        $this->_data['categories'] = ProductsCategorysModel::getAll();
    ...
    public function createAction()
    {
        ...
        if(isset($_POST['submit']) && $this->isValid($this->_createActionRoles, $_POST)) {
            $category = new ProductsCategorysModel();
    ...
    public function editAction()
    {
        ...
        $category = ProductsCategorysModel::getByPK($id);
