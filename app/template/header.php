<header class="main">
    <a href="javascript:;" data-menu-status="false" class="menu_switch"><i class="fas fa-bars"></i></a>
    <h1><?= $text_dashboard ?>
        <?php if (isset($title)): ?>
            <?= ' > ' . $title ?>
        <?php endif; ?>
    ...
    <div class="user_menu_container">
        ...
        <ul class="user_menu">
            ...
            <li><a href="/"><i class="fa fa-cog"></i><?= $text_account_settings ?></a></li>
            <li><a href="/auth/logout"><i class="fa fa-sign-out-alt"></i><?= $text_log_out ?></a></li>
        </ul>
    </div>
