    ...
    <form class="appForm" method="post"  enctype="application/x-www-form-urlencoded">
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <input required type="text" name="name" id="name" placeholder="Write the employee name here" maxlength="50" >
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <input required type="text" name="address" id="address" placeholder="Write the employee Address here" maxlength="100" >
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><label for="tax">ضرائب الموظف :</label></td>
                </tr>
                <tr>
                    <td>
